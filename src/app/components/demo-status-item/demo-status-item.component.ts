...
export class DemoStatusItemComponent implements OnInit {

  nameComponent = 'Status-Item';

  id = 'editable-status-item';
  title: StatusItemTitleData = {
  ...
  ngOnInit(): void {
    ...
    this.item.term.text = 'Término editable';
    this.item.definition.text = 'Definición editable';
    this.item.classes = '';
